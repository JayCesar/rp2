...
from blstm import (
    ...
    TargetScaler, MetricsAccumulator, get_loss_fn, ensure_dir
)
...
class BiLSTMTrainer:
    ...
    def __init__(
        ...
        self.scaler = GradScaler(enabled=self.use_amp and train_config.amp_dtype == 'fp16')
    ...
    def _setup_optimizer(self) -> torch.optim.Optimizer:
        ...
        if self.train_config.optimizer == 'adamw':
            ...
            use_fused = self.device.type == 'cuda' and hasattr(torch.optim.AdamW, '__init__')
            optimizer_kwargs = {
    ...
    def _train_epoch(self) -> float:
        ...
        for batch_idx, batch in enumerate(self.train_loader):
            ...
            if self.use_amp:
                amp_dtype = torch.bfloat16 if self.train_config.amp_dtype == 'bf16' else torch.float16
            ...
            if batch_idx % 100 == 0:
                ...
                logger.info(
                    f"Epoch {self.current_epoch+1}/{self.train_config.epochs} "
        ...
        try:
            for epoch in range(self.train_config.epochs):
                ...
                logger.info(
                    ...
                    f"Val Step Acc: {val_metrics.get('step_accuracy', 0.0):.3f}, "
