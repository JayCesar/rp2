...
3. Atribua uma nota final para a redação, avaliando TODAS as competências do ENEM, usando apenas valores de 0 a 1000 que sejam múltiplos de 40
4. Escreva uma justificativa curta e objetiva para a nota da Competência 1, destacando os principais desvios encontrados ou a ausência deles.
...
- "nota_final": um número inteiro (0, 40, 80, 120, 160 ou 200).
